								...
								<div class="row">
									<div class="col-xs-12">
										<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
											<div class="row">
												<form method="GET" action="<?php echo base_url();?>Client/list_client">
													<div class="col-xs-1">
														<label>Client </label>
													</div>
													<div class="col-md-6">
													...
													<tr>
														...
														<td>
															<div class="action-buttons">
																<a class="blue" href="javascript:void(0);" onclick="showClientDetails('<?php echo $client["id"];?>');">
																	<i class="ace-icon fa fa-info bigger-130"></i>
																</a>
																<a class="green" href="<?php echo base_url()."Client/edit_client/".$client["id"]; ?>">
																	<i class="ace-icon fa fa-pencil bigger-130"></i>
																</a>
																<a title="Add Inventory" class="blue" href="<?php echo base_url(); ?>Client/inventory/<?php echo $client["id"]; ?>" id="175"><i class="menu-icon fa fa-pencil-square-o"></i>
																</a>
																<a title="Inventory" class="blue" href="javascript:void(0);" onclick="showInventoryDetails('<?php echo $client["id"]; ?>');" href="<?php echo base_url(); ?>Client/list_inventory/<?php echo $client["id"]; ?>" id="175"><i class="menu-icon fa fa-book"></i>
																</a>
																<a class="red" href="<?php echo base_url()."Client/delete_client/".$client["id"]; ?>">
