										...
										<div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
											<div class="row">
												<form method="GET" action="<?php echo base_url();?>Brand/list_brand">
													...
													<div class="col-md-6">
														<select style="width:100%;" name="brand_name" aria-controls="dynamic-table" class="form-control allClientList">
															<option value=""></option>
															<?php
													...
													<tr>
														...
														<td>
															<div class="action-buttons">
																<a class="blue" href="javascript:void(0);" onclick="showClientDetails('<?php echo $brand["id"];?>');">
