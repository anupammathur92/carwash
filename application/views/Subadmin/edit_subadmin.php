					...
					<div class="page-content">
						...
						<form class="form-horizontal" role="form" method="POST" action="<?php echo base_url();?>Subadmin/update_subadmin">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="name" id="form-field-1" value="<?php if(isset($subadmin_data)){ echo $subadmin_data['name']; }?>" placeholder="Subadmin Name" class="col-xs-10 col-sm-5" autocomplete="off" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Email </label>
								<div class="col-sm-9">
									<input type="text" name="email" placeholder="Email" value="<?php if(isset($subadmin_data)){ echo $subadmin_data['email']; }?>" 	class="col-xs-10 col-sm-5" autocomplete="off" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Mobile Number </label>
								<div class="col-sm-9">
									<input type="text" name="mobile_number" id="form-field-1" placeholder="Mobile Name" value="<?php if(isset($subadmin_data)){ echo $subadmin_data['mobile_number']; }?>" class="col-xs-10 col-sm-5" autocomplete="off" />
								</div>
							</div>
							<div class="form-group">
