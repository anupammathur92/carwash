					...
					<div class="page-content">
						...
						<input type="hidden" name="update_id" value="<?php echo $category_data["id"]; ?>">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="category_name" placeholder="Category Name" value="<?php if(isset($category_data)){ echo $category_data["category_name"]; } ?>" class="col-xs-10 col-sm-5" autocomplete="off" />
								</div>
							</div>
